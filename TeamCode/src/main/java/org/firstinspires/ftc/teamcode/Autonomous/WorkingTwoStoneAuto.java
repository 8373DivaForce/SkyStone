...
public class WorkingTwoStoneAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (Alliance == 0) {
            ...
            startPosition = new FunctionLibrary.Point(63,-32);

            //set the position of all of the stones
            firstStones[2] = new FunctionLibrary.Point(35,-26);
            secondStones[2] = new FunctionLibrary.Point(33,-51);

            firstStones[1] = new FunctionLibrary.Point(35,-35);
            secondStones[1] = new FunctionLibrary.Point(34,-60);

            firstStones[0] = new FunctionLibrary.Point(35,-44);
            secondStones[0] = new FunctionLibrary.Point(34, -68);
            ...
            firstStones[2] = new FunctionLibrary.Point(-33,-41);
            secondStones[2] = new FunctionLibrary.Point(-30, -66);
        ...
        while (opModeIsActive()) {
            switch(nSwitch) {
                ...
                case 5:
                    ...
                    destination = new FunctionLibrary.Point(finalPosition.x, 15);
                    result = auto.gotoPosition(destination, 1, 1, 0);
                    resetStartTime();
                    if (result < 0) nSwitch++;
                    break;
                ...
                case 12:
                    ...
                    destination = new FunctionLibrary.Point(finalPosition.x, 15.1);
                    result = auto.gotoPosition(destination,1 ,1 ,0);
                    resetStartTime();
                    if (result < 0) nSwitch++;
                    break;
