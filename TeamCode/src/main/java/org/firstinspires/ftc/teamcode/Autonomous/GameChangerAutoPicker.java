...
@TeleOp(group="B")
public class GameChangerAutoPicker extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {

        GamechangerAutoValues stringValues = new GamechangerAutoValues(telemetry);
        ...
        while (opModeIsActive()) {
            ...
            if (valueSelected == "Alliance") {
                ...
                maxIteration = stringValues.startingPositions.length;
            } else if (valueSelected == "EndPosition") {
                maxIteration = stringValues.FinalPositions.length;
            }
